# ═══════════════════════════════════════════════════════════════════════════════
# QuantFolio v2 — moteur d'optimisation complet d'Émilie (VENDORÉ TEL QUEL).
#
# Conservé intégralement pour provenance et pour le RAFRAÎCHISSEMENT HORS-LIGNE des
# statistiques par classe d'actifs (scripts/refresh_asset_class_stats.py), qui
# réutilise son pipeline de données (fetch_returns, conversion EUR, Ledoit-Wolf).
#
# Ce module N'EST PAS importé par l'API (il tire yfinance/scikit-learn). Le chemin
# d'une requête n'utilise que le cœur pur d'app.portfolio.risk_engine.
# ═══════════════════════════════════════════════════════════════════════════════
